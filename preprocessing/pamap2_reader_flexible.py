"""
 ...
 This code is more flexible than the other version and can use all the dimensions of data, the previous version
 is only able to use accelerometer data and gyroscope data (hand)
"""
import numpy as np
import pandas as pd
