...
tf.flags.DEFINE_integer('filter_1_y', 1, 'conv layer 1 - filter y dim')
...
tf.flags.DEFINE_integer('filter_2_y', 1, 'conv layer 2 - filter y dim')
...
tf.flags.DEFINE_integer('filter_3_y', 1, 'conv layer 3 - filter y dim')
...
# logging parameters
tf.flags.DEFINE_string('log_folder', 'logs_classifier_new/52_1d', 'tensorboard logs folder')
