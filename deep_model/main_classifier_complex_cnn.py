...
tf.flags.DEFINE_integer('filters_num_1', 10, 'num of filters in conv layer 1')
tf.flags.DEFINE_integer('stride_1_x', 5, 'conv layer 1 - filter movement in x dim')
...
tf.flags.DEFINE_integer('filter_2_y', 5, 'conv layer 2 - filter y dim')
tf.flags.DEFINE_integer('filters_num_2', 10, 'num of filters in conv layer 2')
...
tf.flags.DEFINE_integer('filters_num_3', 15, 'num of filters in conv layer 3')
