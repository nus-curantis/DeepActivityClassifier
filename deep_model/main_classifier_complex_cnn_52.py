...
tf.flags.DEFINE_integer('filter_1_x', 4, 'conv layer 1 - filter x dim')
tf.flags.DEFINE_integer('filter_1_y', 4, 'conv layer 1 - filter y dim')
# tf.flags.DEFINE_integer('filters_num_1', 30, 'num of filters in conv layer 1')
tf.flags.DEFINE_integer('filters_num_1', 40, 'num of filters in conv layer 1')
...
tf.flags.DEFINE_integer('stride_1_x', 2, 'conv layer 1 - filter movement in x dim')
tf.flags.DEFINE_integer('stride_1_y', 2, 'conv layer 1 - filter movement y dim')
...
tf.flags.DEFINE_integer('filter_2_x', 4, 'conv layer 2 - filter x dim')
tf.flags.DEFINE_integer('filter_2_y', 4, 'conv layer 2 - filter y dim')
# tf.flags.DEFINE_integer('filters_num_2', 30, 'num of filters in conv layer 2')
tf.flags.DEFINE_integer('filters_num_2', 40, 'num of filters in conv layer 2')
...
tf.flags.DEFINE_integer('stride_2_x', 2, 'conv layer 2 - filter movement in x dim')
tf.flags.DEFINE_integer('stride_2_y', 2, 'conv layer 2 - filter movement y dim')
...
tf.flags.DEFINE_integer('filters_num_3', 30, 'num of filters in conv layer 3')
...
tf.flags.DEFINE_integer('stride_3_x', 2, 'conv layer 3 - filter movement in x dim')
tf.flags.DEFINE_integer('stride_3_y', 2, 'conv layer 3 - filter movement y dim')
