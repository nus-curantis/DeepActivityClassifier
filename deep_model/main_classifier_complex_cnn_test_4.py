...
tf.flags.DEFINE_integer('filter_1_x', 30, 'conv layer 1 - filter x dim')
...
tf.flags.DEFINE_integer('stride_1_x', 10, 'conv layer 1 - filter movement in x dim')
...
# logging parameters
tf.flags.DEFINE_string('log_folder', 'logs_classifier/test_4', 'tensorboard logs folder')
